...
class SingleColorViewController: UIViewController, PageItemType {
    let pageIndex = 3
    ...
    func drawGradientCircular() {
        ...
        let style = GradientCircularConf.Style(frame: rect,
                                               lineWidth: 30.0,
                                               gradient: (UIColor(red: 51.0/255.0, green: 153.0/255.0, blue: 1.0, alpha: 1.0),
                                                          UIColor(red: 51.0/255.0, green: 153.0/255.0, blue: 1.0, alpha: 1.0)))
        self.style = style
